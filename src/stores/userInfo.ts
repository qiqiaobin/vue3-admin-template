...
export const useUserInfo = defineStore('userInfo', {
	...
	actions: {
		...
		async getApiUserInfo() {
          ...
          let adminPermissions: Array<string> = ['/home','/chart','/personal','/tree','/system','/system/menu','/system/role','/system/user','/system/role/add','/system/menu/add','/limits/frontEnd/page','/limits/backEnd/page','/limits'];
